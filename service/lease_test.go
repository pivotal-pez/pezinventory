	...
	var (
		...
		fakeLeaseCollection = []Lease{
			Lease{
				...
				User:              "testuser-1",
				DurationDays:      14,
				StartDate:         time.Now().AddDate(0, 0, -2).UTC().String(),
				EndDate:           time.Now().AddDate(0, 0, 11).UTC().String(),
				Status:            "active",
			...
			Lease{
				...
				User:              "testuser-2",
				DurationDays:      28,
				StartDate:         time.Now().AddDate(0, 0, -14).UTC().String(),
				EndDate:           time.Now().AddDate(0, 0, 13).UTC().String(),
				Status:            "active",
				Attributes:        map[string]interface{}{"public": "info"},
				PrivateAttributes: map[string]interface{}{"secret": "stuff"},
			},
